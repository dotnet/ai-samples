...
2. Switch to the newly created `06 - Modifying Kernel Behavior with Dependency Injection` directory.
...
6. Install Extensions.Compliance.Redaction nuget package

```shell
dotnet add package Microsoft.Extensions.Compliance.Redaction
```

7. Install Extensions.Http nuget package

```shell
dotnet add package Microsoft.Extensions.Http
```

8. Install Extensions.Http.Resilience nuget package
...
9. Install SemanticKernel.Plugins.Web nuget package

```shell
dotnet add package Microsoft.SemanticKernel.Plugins.Web
```

10. Open the project in VS Code or Visual Studio.

11. In the Program.cs file, delete all the existing code.

12. Add the following using statments at the top of `Program.cs` file.
...
13. Add model name and create builder
...
14.  Modify the kernel behavior  by injecting  services into it.
...
15. Initialize the kernel and more
...
17.Implment  `IFunctionInvocationFilter`
...
```
 ...
 18. Run the application by entering `dotnet run` into the terminal. Experiment with a user prompt "What are the major Microsoft announcements in Build 2024?" and if you enter "y" for `Allow Search?`
