...
{
    [TestMethod]
    public async Task Example18_GeneratingReportProgrammaticallyFromAzureStorage()
    {
        ...
        /// <see cref="Example13_UsingAzureStorage_01"/> and <see cref="Example14_UsingAzureStorage_02"/>.
