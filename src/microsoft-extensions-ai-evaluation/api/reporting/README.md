...
| [ReportingExamples.Example08_RunningSafetyEvaluators.cs](./ReportingExamples.Example08_RunningSafetyEvaluators.cs) | Demonstrates how to run Safety evaluators that leverage the Azure AI Content Safety service to evaluate content harm and safety metrics.<br><br>See [Running Content Safety evaluation examples](../INSTRUCTIONS.md#running-content-safety-evaluation-examples) for instructions to configure the Azure AI Content Safety service for this example.<br><br>Inspect the generated report at the end and click on each of the Content Safety metrics under this example to view additional details for each metric. |
| [ReportingExamples.Example09_RunningSafetyEvaluatorsAgainstResponsesWithImages.cs](./ReportingExamples.Example09_RunningSafetyEvaluatorsAgainstResponsesWithImages.cs) | Demonstrates how to run Safety evaluators that leverage the Azure AI Content Safety service to evaluate content harm and safety metrics for responses that contain images.<br><br>See [Running Content Safety evaluation examples](../INSTRUCTIONS.md#running-content-safety-evaluation-examples) for instructions to configure the Azure AI Content Safety service for this example.<br><br>Inspect the generated report at the end and click on each of the Content Safety metrics under this example to view additional details for each metric. |
| [ReportingExamples.Example10_RunningQualityAndSafetyEvaluatorsTogether.cs](./ReportingExamples.Example10_RunningQualityAndSafetyEvaluatorsTogether.cs) | Demonstrates how to run (LLM-based) Quality evaluators and Safety evaluators (that leverage the Azure AI Content Safety service) as part of the same `ReportingConfiguration`.<br><br>See [Running Content Safety evaluation examples](../INSTRUCTIONS.md#running-content-safety-evaluation-examples) for instructions to configure the Azure AI Content Safety service for this example. |
| [ReportingExamples.Example11_UsingAzureStorage_01.cs](./ReportingExamples.Example11_UsingAzureStorage_01.cs) | Demonstrates how to use Azure storage providers to store evaluation results and to cache LLM responses in an Azure storage container.<br><br>See [Running Azure storage examples](../INSTRUCTIONS.md#running-azure-storage-examples) for instructions to configure Azure storage for this example. |
| [ReportingExamples.Example12_UsingAzureStorage_02.cs](./ReportingExamples.Example12_UsingAzureStorage_02.cs) | Another example that demonstrates how to Azure storage providers to store evaluation results and to cache LLM responses in an Azure storage container.<br><br>See [Running Azure storage examples](../INSTRUCTIONS.md#running-azure-storage-examples) for instructions to configure Azure storage for this example. |
| [ReportingExamples.Example13_UsingCustomStorage_01.cs](./ReportingExamples.Example13_UsingCustomStorage_01.cs) | Demonstrates how to use custom (SQLite-based) storage providers to store evaluation results and to cache LLM responses. |
| [ReportingExamples.Example14_UsingCustomStorage_02.cs](./ReportingExamples.Example14_UsingCustomStorage_02.cs) | Another example that demonstrates how to use custom (SQLite-based) storage providers to store evaluation results and to cache LLM responses. |
| [ReportingExamples.Example15_GeneratingReportProgrammatically.cs](./ReportingExamples.Example15_GeneratingReportProgrammatically.cs) | Demonstrates how to generate a report for the most recent execution of the examples above that store their evaluation results on disk (using `DiskBasedReportingConfiguration` and `DiskBasedResultStore`). |
| [ReportingExamples.Example16_GeneratingReportProgrammaticallyFromAzureStorage.cs](./ReportingExamples.Example16_GeneratingReportProgrammaticallyFromAzureStorage.cs) | Demonstrates how to generate a report for the most recent execution of the examples above that store their evaluation results in an Azure storage container. |
| [ReportingExamples.Example17_GeneratingReportProgrammaticallyFromCustomStorage.cs](./ReportingExamples.Example17_GeneratingReportProgrammaticallyFromCustomStorage.cs) | Demonstrates how to generate a report for the most recent execution of the examples above that store their evaluation results in a custom (SQLite-based) result store. |
