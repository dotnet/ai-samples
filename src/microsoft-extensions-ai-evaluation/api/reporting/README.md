...
| [ReportingExamples.Example10_UsingAzureStorage_01.cs](./ReportingExamples.Example10_UsingAzureStorage_01.cs) | Demonstrates how to use Azure storage providers to store evaluation results and to cache LLM responses in an Azure storage container.<br><br>See [Running Azure storage examples](../INSTRUCTIONS.md#running-azure-storage-examples) for instructions to configure Azure storage for this example. |
| [ReportingExamples.Example11_UsingAzureStorage_02.cs](./ReportingExamples.Example11_UsingAzureStorage_02.cs) | Another example that demonstrates how to Azure storage providers to store evaluation results and to cache LLM responses in an Azure storage container.<br><br>See [Running Azure storage examples](../INSTRUCTIONS.md#running-azure-storage-examples) for instructions to configure Azure storage for this example. |
| [ReportingExamples.Example12_UsingCustomStorage_01.cs](./ReportingExamples.Example12_UsingCustomStorage_01.cs) | Demonstrates how to use custom (SQLite-based) storage providers to store evaluation results and to cache LLM responses. |
| [ReportingExamples.Example13_UsingCustomStorage_02.cs](./ReportingExamples.Example13_UsingCustomStorage_02.cs) | Another example that demonstrates how to use custom (SQLite-based) storage providers to store evaluation results and to cache LLM responses. |
| [ReportingExamples.Example14_GeneratingReportProgrammatically.cs](./ReportingExamples.Example14_GeneratingReportProgrammatically.cs) | Demonstrates how to generate a report for the most recent execution of the examples above that store their evaluation results on disk (using `DiskBasedReportingConfiguration` and `DiskBasedResultStore`). |
| [ReportingExamples.Example15_GeneratingReportProgrammaticallyFromAzureStorage.cs](./ReportingExamples.Example15_GeneratingReportProgrammaticallyFromAzureStorage.cs) | Demonstrates how to generate a report for the most recent execution of the examples above that store their evaluation results in an Azure storage container. |
| [ReportingExamples.Example16_GeneratingReportProgrammaticallyFromCustomStorage.cs](./ReportingExamples.Example16_GeneratingReportProgrammaticallyFromCustomStorage.cs) | Demonstrates how to generate a report for the most recent execution of the examples above that store their evaluation results in a custom (SQLite-based) result store. |
